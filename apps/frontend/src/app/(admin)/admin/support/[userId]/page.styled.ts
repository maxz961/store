export const s = {
  ...
  bubbleUser: 'max-w-[75%] rounded-2xl rounded-tr-sm bg-muted px-4 py-2.5 text-sm',
  bubbleAdmin: 'max-w-[75%] rounded-2xl rounded-tl-sm bg-primary px-4 py-2.5 text-sm text-primary-foreground',
