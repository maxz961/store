export const s = {
  ...
  discount: 'rounded-md bg-red-100 dark:bg-red-900/60 px-2 py-0.5 text-sm font-medium text-red-600 dark:text-red-400',
  ...
  favoriteButton: 'flex h-11 w-11 shrink-0 items-center justify-center rounded-lg border border-border bg-card transition-all duration-150 hover:border-muted-foreground/30 hover:bg-muted dark:hover:bg-white/10',
