...
import { useMyUnreadCount } from '@/lib/hooks/useSupport';
...
export const Header = () => {
  ...
  const { data: unreadCount } = useMyUnreadCount();
      ...
      <div className={s.container}>
        ...
        <div className={s.actions}>
          ...
          <If condition={isAuthenticated && !!user}>
            <Then>
              <Dropdown className="relative" trigger={<UserTrigger image={user?.image} initials={initials} hasUnreadMessages={!!unreadCount && unreadCount > 0} />}>
