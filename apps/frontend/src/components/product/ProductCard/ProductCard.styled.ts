export const s = {
  ...
  cartButton: 'flex items-center justify-center h-9 w-9 rounded-lg transition-all duration-300',
  cartButtonIdle: 'bg-primary text-primary-foreground hover:bg-primary/90',
  cartButtonLoading: 'bg-primary text-primary-foreground cursor-wait',
  cartButtonSuccess: '!w-auto px-2.5 gap-1.5 bg-green-500 text-white hover:bg-green-500',
  cartButtonIcon: 'h-4 w-4 shrink-0',
  cartButtonSuccessIcon: 'h-3.5 w-3.5 shrink-0 animate-success-pop',
  cartButtonAddedText: 'text-xs font-medium whitespace-nowrap',
