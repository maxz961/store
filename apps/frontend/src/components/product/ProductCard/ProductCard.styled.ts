export const s = {
  ...
  cartButton: 'flex items-center justify-center h-9 w-9 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-150',
  cartButtonAdded: '!w-auto px-2.5 gap-1.5 bg-green-500 text-white hover:bg-green-500',
  cartButtonBouncing: 'scale-0 opacity-0',
  cartButtonIcon: 'h-4 w-4 shrink-0',
  cartButtonAddedIcon: 'h-3.5 w-3.5 shrink-0',
