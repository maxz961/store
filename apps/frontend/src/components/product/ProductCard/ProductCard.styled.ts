export const s = {
  ...
  cartButton: 'flex items-center justify-center h-9 w-9 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-200',
  cartButtonAdded: '!w-auto px-2.5 gap-1.5 bg-green-500 text-white hover:bg-green-500',
  cartButtonBouncing: 'scale-110',
