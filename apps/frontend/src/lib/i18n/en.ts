  ...
  admin: {
    ...
    promotion: {
      ...
      validation: {
        ...
        slugFormat: 'Lowercase Latin letters, digits and hyphens only',
        descriptionMin: 'Min 10 characters',
        descriptionMax: 'Max 500 characters',
        bannerRequired: 'Banner image URL is required',
        startDateRequired: 'Start date is required',
        endDateRequired: 'End date is required',
        discountRequired: 'Discount amount is required',
        discountPositive: 'Discount must be greater than 0',
        positionInvalid: 'Position cannot be negative',
      },
    },
    order: {
      title: 'Orders',
